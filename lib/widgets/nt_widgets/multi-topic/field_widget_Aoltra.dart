...
class FieldWidgetAoltraModel extends NTWidgetModel {
  ...
  double ModuleWidthMeters = 0.14;
  double ModuleLengthMeters = 0.14;
  ...
  FieldWidgetAoltraModel.fromJson({required Map<String, dynamic> jsonData})
...
class FieldWidgetAoltra extends NTWidget {
  static const String widgetType = 'Field Aoltra';
  final bool isRedAlliance;

  FieldWidgetAoltra({super.key}) : isRedAlliance = gIsRedAlliance;

  double _getBackgroundFitWidth(FieldWidgetAoltraModel model, Size size) {
  ...
  Widget _getTransformedFieldModule(
      FieldWidgetAoltraModel model,
      List<double> objectPosition,
      Offset center,
      Offset fieldCenter,
